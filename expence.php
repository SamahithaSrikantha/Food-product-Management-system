...
<div class="cotaier" id="header">
 ...
 <div class="col-lg-12">
 <br><br>
 <h1 class="text-warning text-center" > Our Expenditure  </h1>
 <br>
...
while($res =mysqli_fetch_array($query)) {
    ...
    <td><?php echo $res['descriptor'];?></td>
    <td><a href="updexp.php?id=<?php echo $res['product_name'];?>"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
    <td><a href="delexp.php?id=<?php echo $res['product_name'];?>"><i class="fa fa-trash" aria-hidden="true"></i></td>
    <td><a href="addexp.php"><?php echo 'add';?></a></td>
</tr>
<?php
}  
 ?>  
